...
module.exports = {"player":1,"playerProjectile":2,"enemy":4,"enemyProjectile":8,"powerup":16}
...
var _objectTypes = __webpack_require__(6);
...
PlayerShip.prototype.type = _objectTypes2.default.player;
...
Enemy.prototype.type = _objectTypes2.default.enemy;

Enemy.prototype.step = function step(dt) {
    var collision = this.board.collide(this, _objectTypes2.default.player);
...
Enemy.prototype.hit = function (damage) {
    ...
    if (this.health <= 0) {
        if (this.board.remove(this)) {
            this.board.add(new _Explosion2.default(this.spriteSheet, this.x + this.w / 2, this.y + this.h / 2));
        }
    }
};
...
module.exports = {"basic":{"x":100,"y":-50,"sprite":"enemyPurple","B":100,"C":2,"E":100,"health":20},"straight":{"x":0,"y":-50,"sprite":"enemyShip","health":10,"E":100},"ltr":{"x":0,"y":-100,"sprite":"enemyPurple","health":10,"B":500,"C":4,"E":200},"circle":{"x":400,"y":-50,"sprite":"enemyCircle","health":10,"A":0,"B":-200,"C":1,"E":20,"F":200,"G":1,"H":1.57079632679},"wiggle":{"x":100,"y":-50,"sprite":"enemyBee","health":20,"B":100,"C":4,"E":100},"step":{"x":0,"y":-50,"sprite":"enemyCircle","health":10,"B":575,"C":4,"E":60}}
...
var _Example3 = __webpack_require__(36);

var _Example4 = _interopRequireDefault(_Example3);

var _Example5 = __webpack_require__(38);

var _Example6 = _interopRequireDefault(_Example5);

var _Example7 = __webpack_require__(40);
...
var Example1 = function (_React$Component) {
    ...
    _createClass(Example1, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "flex" },
                    _react2.default.createElement("canvas", { ref: this.setCanvasRef, width: "300", height: "300" })
                )
            );
        }
    }, {
        ...
        value: function componentDidMount() {
            ...
            var example = new _example2.default(this.canvas, context);
        }
    }]);
...
var example1 = function example1(canvas, context) {
    var _this = this;
    ...
    this.image.onload = function () {
        ...
        // Draw rectangle at origin 0, 0 with height and width of 30px
        _this.context.fillRect(0, 0, 30, 30);

        _this.context.fillStyle = "#ff021f";
...
var _example = __webpack_require__(37);
...
var Example2 = function (_React$Component) {
    _inherits(Example2, _React$Component);
    ...
    _createClass(Example2, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "flex" },
                    _react2.default.createElement("canvas", { ref: this.setCanvasRef, width: "600", height: "300" })
                )
            );
        }
    }, {
        ...
        value: function componentDidMount() {
            ...
            var example = new _example2.default(this.canvas, data, {});
...
var StackedBarGraph = function stackedBarGraph(canvas, initData, options) {
    var defaultOptions = {
        "watermark": false
    };
    ...
    this.getMaxChartValue = function getMaxChartValue(num) {
        ...
        var numberDigits = stringifiednum.length;
        var newNum = void 0;
    ...
    this.drawColumns = function drawColumns() {
        ...
        for (i; i < this.data.length; i++) {
            ...
            for (score in this.data[i].values) {
                ...
                this.context.rect(x + blockWidth * 0.1, y, blockWidth * 0.8, blockHeight);
    ...
    this.drawColumnLabel = function drawColumnLabel(category, blockWidth, x, y, i) {
        ...
        this.context.beginPath();
        this.context.rect(labelX, y, textWidth, 13);
        this.context.closePath();
    ...
    this.checkHoverHighlight = function checkHoverHighlight(category, score, x, y, blockWidth, blockHeight) {
        if (this.hover["" + category + score]) {
            ...
            this.context.beginPath();
            this.context.rect(x, y, blockWidth, blockHeight);
            this.context.closePath();
            this.context.fill();
...
var Example3 = function (_React$Component) {
    _inherits(Example3, _React$Component);
    ...
    _createClass(Example3, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "example" },
                _react2.default.createElement(_ExampleHeader2.default, { title: "requestAnimationFrame - Basic", code: code }),
                _react2.default.createElement(
                    "div",
                    { className: "flex" },
                    _react2.default.createElement("canvas", { ref: this.setCanvasRef, width: "600", height: "300" }),
...
var Example3 = function example3(canvas) {
    var _this = this;
    ...
    this.draw = function () {
        _this.gameTime = Math.floor(_this.currentFrameTime);
        ...
        _this.context.fillStyle = "#000000";
        _this.context.fillRect(_this.x, _this.y, 20, 20);
    };

    this.calculateDirection = function () {
        if (_this.direction == "right" && _this.x >= _this.canvas.width - 20) {
...
var Example5 = function (_React$Component) {
    _inherits(Example5, _React$Component);

    function Example5(props) {
        _classCallCheck(this, Example5);

        var _this = _possibleConstructorReturn(this, (Example5.__proto__ || Object.getPrototypeOf(Example5)).call(this, props));
    ...
    _createClass(Example5, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "flex" },
                    _react2.default.createElement("canvas", { ref: this.setCanvasRef, width: "320", height: "480" })
                )
            );
        }
    }, {
        ...
        value: function componentDidMount() {
            var context = this.canvas.getContext("2d");
            var example = new _game2.default(this.canvas, context);
...
var _PlayerShip = __webpack_require__(15);
...
var _enemyData = __webpack_require__(17);
...
var Game = function Game(canvas, context) {
    ...
    this.playGame = function () {
        ...
        board.add(new _Level2.default(_this, _this.spriteSheet, _levelData2.default.level1, _this.winGame));

        _this.setBoard(3, board);
    };

    this.winGame = function () {
        _this.setBoard(3, new _engine2.default.TitleScreen(_this, "You Win!", "Press spacebar to play again", _this.playGame));
    };

    this.loseGame = function () {
        _this.setBoard(3, new _engine2.default.TitleScreen(_this, "You Lose!", "Press spacebar to play again", _this.playGame));
    };
};
...
var Engine = {
    ...
    "GameBoard": function GameBoard() {
        ...
        this.add = function (obj) {
            ...
            _this2.cnt[obj.type] = (_this2.cnt[obj.type] || 0) + 1;
...
PlayerMissle.prototype = new _Sprite2.default();

PlayerMissle.prototype.type = _objectTypes2.default.playerProjectile;

PlayerMissle.prototype.step = function step(dt) {
    var collision = this.board.collide(this, _objectTypes2.default.enemy);
...
var Explosion = function Explosion(SpriteSheet, centerX, centerY) {
...
Level.prototype.step = function step(dt) {
    ...
    while ((curShip = this.levelData[idx]) && curShip[0] < this.t + 2000) {
        ...
        if (this.t > curShip[1]) {
            ...
            var enemy = _enemyData2.default[curShip[3]];
            var override = curShip[4];

            // Add a new enemy with the blueprint and override
            this.board.add(new _Enemy2.default(this.game, this.spriteSheet, enemy, override));
    ...
    if (this.levelData.length == 0 && this.board.cnt[_objectTypes2.default.enemy] == 0) {
        if (this.callback) {
            this.callback();
        }
    }
